          ...
          {resources.length === 0 ? (
            ...
            resources.map((resource) => {
              ...
              const tagClass = isHospital
                ? 'text-rose-600 bg-rose-50 border border-rose-100/60'
                : isShelter
                  ? 'text-emerald-700 bg-emerald-50 border border-emerald-100/60'
                  : 'text-[color:var(--sky)] bg-sky-50 border border-sky-100/60';
              ...
              return (
                <article key={resource.name} className="rounded-3xl border border-[color:var(--outline-variant)]/50 bg-[color:var(--surface-soft)]/20 p-5 flex flex-col justify-between hover:bg-[color:var(--surface-soft)]/40 hover:border-[color:var(--accent)]/30 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-3 rounded-2xl bg-white border border-[color:var(--outline-variant)]/20 px-3 py-1.5 text-xs text-[color:var(--muted)] text-center font-medium">
                      {resource.openStatus}
                    </div>
                  </div>
                </article>
